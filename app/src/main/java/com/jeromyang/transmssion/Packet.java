...
public class Packet {
     ...
     * @return
     */
    private boolean destinationIpWapper(ByteArrayOutputStream byteArrayOutputStream,byte[] bytes){

        if (bytes == null){// 封装的地址为当前网段的广播地址
    ...
    public ByteArrayOutputStream getSendOnlineBroadCast(){
        ...
        if (onlineBroadcast==null){
            ...
            destinationIpWapper(onlineBroadcast,null);
        }
